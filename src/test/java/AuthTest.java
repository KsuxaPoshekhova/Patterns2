...
public class AuthTest {
    ...
    void SuccessfulLoginOfRegisteredUser() {
    ...
    @Test
    @DisplayName("Unregistered user login")
    void UnregisteredUserLogin() {
        var notRegisteredUser = getUser("active");
        $("[data-test-id='login'] input").setValue(notRegisteredUser.getLogin());
        $("[data-test-id='password'] input").setValue(notRegisteredUser.getPassword());
        $("button.button").click();
        $("[data-test-id='error-notification'] .notificator")
    ...
    @Test
    @DisplayName("Login entered with error")
    void LoginEnteredWithError() {
        var registeredUser = getRegisteredUser("active");
    ...
    @Test
    @DisplayName("Password entered with error")
    void PasswordEnteredWithError() {
        var registeredUser = getRegisteredUser("active");
